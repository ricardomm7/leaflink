...
public class MaintenanceTest {
    ...
    public static class TestMaintenance{
        // The constructor initializes the data, vehiclePlate, and km attributes with the values passed as parameters.
        @Test
    ...
    public static class TestGetVehiclePlate{
    ...
    public static class TestGetDate{
