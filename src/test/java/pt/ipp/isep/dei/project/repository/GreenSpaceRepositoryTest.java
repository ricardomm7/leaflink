...
class GreenSpaceRepositoryTest {
    ...
    void testCreate_AddGreenSpace() {
        ...
        repository.create((GreenSpaceMapper.toDomain(new GreenSpaceDto("Park", GreenSpaceType.LARGE_SIZED_PARK, 10.5, manager, address.getAddress(), address.getCity(), address.getZipCode()))));
    ...
    void testCreate_DuplicateName() {
        ...
        assertThrows(IllegalArgumentException.class, () ->
                repository.create((GreenSpaceMapper.toDomain(new GreenSpaceDto("Park", GreenSpaceType.LARGE_SIZED_PARK, 20.0, manager, address.getAddress(), address.getCity(), address.getZipCode())))
                ));
    }
}
