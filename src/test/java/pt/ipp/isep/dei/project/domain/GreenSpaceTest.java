...
class GreenSpaceTest {
    ...
    void testConstructorAndGetters() {
        ...
        GreenSpace greenSpace = new GreenSpace("Park", GreenSpaceType.MEDIUM_SIZED_PARK, 10.5, manager.getUserEmail(), address);
        ...
        assertEquals(manager.getUserEmail(), greenSpace.getManager());
        assertEquals(address, greenSpace.getAddress());
    }

    @Test
    void testSetName_ValidName() {
        GreenSpace greenSpace = new GreenSpace("Park", GreenSpaceType.MEDIUM_SIZED_PARK, 10.5, new UserSession(new pt.isep.lei.esoft.auth.UserSession(new User(new Email("a@a.com"), new Password("abcd"), "Ana"))).getUserEmail(), new Address("Street", "City", "9999-999"));
